...
OUTPUT_PATH = project_root / "test/test_vectors/production/register/registration_confirmation_vectors.json"
...
def generate_registration_confirmation_vector(actor_name):
    ...
    intent_file = project_root / "test" / "test_vectors" / "production" / "register" / "registration_intent_vectors.json"
