...
def generate_pq_removal_vectors():
    """Generate test vectors for PQ-side registration removal for 5 production actors"""
    pq_removal_vectors = []
...
def main():
    ...
    try:
        ...
        # Save to JSON file
        output_file = project_root / "test/test_vectors/production/register/registration_pq_removal_vectors.json"
