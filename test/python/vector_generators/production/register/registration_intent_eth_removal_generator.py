...
def generate_remove_registration_intent_vectors():
    """Generate test vectors for removing registration intents for all 5 production actors"""
    remove_vectors = []
...
def main():
    ...
    try:
        ...
        # Save to JSON file
        output_file = project_root / "test/test_vectors/production/register/registration_eth_removal_vectors.json"
