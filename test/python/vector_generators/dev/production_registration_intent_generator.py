#!/usr/bin/env python3
"""
Production Registration Intent Vector Generator
...
OUTPUT_PATH = PROJECT_ROOT / "test/test_vectors/dev/registration_intent_vectors.json"
...
def main():
    print("Starting PRODUCTION registration intent vector generation...")
    ...
    print(f"Writing {len(vectors)} production vectors to {OUTPUT_PATH}")
    with open(OUTPUT_PATH, "w") as f:
        json.dump({"registration_intent": vectors}, f, indent=2)
    
    print("✅ Production registration intent vectors generated!")
