...
echo "Deploying contracts with standalone libraries to OP Sepolia..."
echo "Using RPC URL: $RPC_URL"
echo "Using Epervier Verifier: $EPERVIER_VERIFIER_ADDRESS"

# Run the deployment with optimization enabled
forge script script/DeployWithStandaloneLibraries.s.sol:DeployWithStandaloneLibrariesScript \
    --rpc-url $RPC_URL \
    --broadcast \
    --verify \
